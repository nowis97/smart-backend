...
@model({settings: {idInjection: false, mssql: {schema: 'dbo', table: 'preventiva'}}})
export class Preventiva extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 10,
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'butilo', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'NO'},
  })
  butilo: number;
  ...
  constructor(data?: Partial<Preventiva>) {
    super(data);
  }
}

export interface PreventivaRelations {
  // describe navigational properties here
}

export type PreventivaWithRelations = Preventiva & PreventivaRelations;
